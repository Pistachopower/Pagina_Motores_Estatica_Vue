  ...
  <div class="container py-4">
    ...
    <section class="busqueda-section mb-4">
      <form @submit.prevent class="d-flex justify-content-center">
        <input type="text" class="form-control form-control-lg w-100 w-md-75" placeholder="Buscar productos..."
          v-model="busqueda" />
      </form>
    </section>
        ...
        <div class="col-12 col-sm-6 col-md-4" v-for="producto in productosFiltrados"
          ...
          <div class="card h-100 shadow-sm">
            ...
            <router-link :to="`/product/${producto.tipo}/${producto.id}`">
              <img :src="producto.imagenes ? producto.imagenes[0] : ''" class="card-img-top"
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-12 col-md-4">
            <div class="card border-0 h-100 shadow-sm">
              <div class="card-body d-flex">
                <div class="d-flex align-items-center justify-content-center me-3" style="
                  width: 60px;
                  height: 60px;
                  border-radius: 50%;
                ...
                <div>
                  ...
                  <div class="d-flex align-items-center gap-2 flex-wrap">
                    <img src="/src/assets/payment.png" alt="Métodos de pago seguros" width="120" height="auto"
                      class="img-fluid" />
                  </div>
                </div>
              </div>
            ...
            <div class="card border-0 h-100 shadow-sm">
              <div class="card-body d-flex">
                ...
                <div>
                  ...
                  <p class="mb-0 text-body-secondary">
                    Plazo máximo entre la recepción del pedido y su entrega entre 24h. y 72h. con su agencia de
                    transportes.
                  </p>
                </div>
              </div>
